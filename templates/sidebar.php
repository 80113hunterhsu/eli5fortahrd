<nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li class="sidebar-nav-item"> 
            ...
            <li class="sidebar-nav-item hider"> <a class="js-scroll-trigger nav_dt" href="../subjects/EngineeringDesign.html">工程設計</a> </li>
        <!--lt-->
        <li class="sidebar-nav-item"> 
        ...
        <!--------------------------------->
        <li class="sidebar-nav-item"> 
            <a class="js-scroll-trigger" href="../user/login.html">登入</a>
            <span> / </span>
            <a class="js-scroll-trigger" href="../user/register.html">註冊</a>
        </li>
